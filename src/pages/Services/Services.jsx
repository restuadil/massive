    ...
    return (
        <>
            ...
            <div className="bg-slate-300 py-3 ">
                <h1 className="font-poppins font-bold text-3xl text-center py-3">Mengapa Vaksinasi itu penting?</h1>
                <div className="text-center flex flex-col gap-3 md:flex-row md:items-center md:justify-between md:mx-10">
                    <img src="img/hero.jpeg" alt="" className="md:w-1/3" />
                    <div className="">
            ...
            <div>
                ...
                <div className="bg-center bg-cover bg-no-repeat py-5"
                    ...
                    <h1 className="font-poppins font-bold text-3xl my-3 text-center">Syarat Vaksin</h1>
            ...
            <Vaccine data={dataVaksinKucing} title={"Data Vaksin Kucing"} />
            <Vaccine data={dataVaksinKucing} title={"Data Vaksin Anjing"} />
